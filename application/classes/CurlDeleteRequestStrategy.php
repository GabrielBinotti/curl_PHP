...
/**
 * Classe CurlDeleteRequestStrategy que implementa a interface InterfaceCurlStrategy configurando
 * as opções de uma requisição DELETE usando o cURL.
 */
class CurlDeleteRequestStrategy implements InterfaceCurlStrategy
{

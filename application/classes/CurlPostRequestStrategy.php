...
/**
 * Classe CurlPostRequestStrategy que implementa a interface InterfaceCurlStrategy configurando
 * as opções de uma requisição POST usando o cURL.
 */
class CurlPostRequestStrategy implements InterfaceCurlStrategy
{

...
/**
 * Classe CurlGetRequestStrategy que implementa a interface InterfaceCurlStrategy configurando
 * as opções de uma requisição GET usando o cURL.
 */
class CurlGetRequestStrategy implements InterfaceCurlStrategy
{
